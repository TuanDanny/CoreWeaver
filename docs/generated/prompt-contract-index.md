...
| Agent4 runtime prompt | `semiconductor_swarm/agents/agent4_physical/agent4_prompt.py` | `docs/prompts/index.md` | `tests/test_agent4.py` |
| Agent5 runtime prompt | `semiconductor_swarm/agents/agent5_formal/agent5_prompt.py` | `docs/prompts/index.md` | `tests/test_agent5.py` |

## Drift Rule
Do not copy canonical prompt bodies. Reference canonical paths.
