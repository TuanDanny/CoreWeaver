...
- Public benchmark corpus has 20 smoke/mutation cases with schema validation and pass-rate reporting.
...
- Next quality frontier is deeper live `local_llm` structured output evaluation with a configured endpoint; current acceptance is fake-client and deterministic.
